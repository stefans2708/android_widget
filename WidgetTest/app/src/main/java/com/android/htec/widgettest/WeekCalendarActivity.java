...
public class WeekCalendarActivity extends AppCompatActivity implements WeekAdapter.OnSelectedDateChangeListener {
    ...
    private void initViews() {
        ...
        final WeekAdapter adapter = new WeekAdapter(2019, this, selectedDay, this);
        ...
        recyclerView.addOnScrollListener(new OnNextWeekListener() {
            @Override
            public void onNewWeek(int weekItemPosition) {
                WeekData weekData = adapter.getItem(weekItemPosition);
                txtMonthName.setText(weekData.getMonthName());  //cool
                selectedDay = currentWeekPosition < weekItemPosition ? selectedDay.plusDays(7) : selectedDay.minusDays(7);
                currentWeekPosition = weekItemPosition;
    ...
    @Override
    public void onDaySelected(DateTime selectedDay) {
        this.selectedDay = selectedDay;
        txtSelectedDay.setText(selectedDay.toString());
        DateFormatSymbols dfs = new DateFormatSymbols();
        txtMonthName.setText(dfs.getMonths()[selectedDay.getMonthOfYear() - 1]);
    }
